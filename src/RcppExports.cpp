...
RcppExport SEXP _looperr_timesTwo(SEXP xSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _looperr_fastols(SEXP ySEXP, SEXP XSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec& >::type y(ySEXP);
    Rcpp::traits::input_parameter< arma::mat& >::type X(XSEXP);
    rcpp_result_gen = Rcpp::wrap(fastols(y, X));
    return rcpp_result_gen;
END_RCPP
}
// hatdiag
...
static const R_CallMethodDef CallEntries[] = {
    {"_looperr_timesTwo", (DL_FUNC) &_looperr_timesTwo, 1},
    {"_looperr_dmvnrm", (DL_FUNC) &_looperr_dmvnrm, 4},
    {"_looperr_fastols", (DL_FUNC) &_looperr_fastols, 2},
